...
#define STRING_CONFIG_H_AUTHOR "(merin, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Merin's E3"
...
// #define XY_PROBE_SPEED (133*60) merin12142020 - incomming not accepted
